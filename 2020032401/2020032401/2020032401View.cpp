...
// 2020032401View.cpp : CMy2020032401View 类的实现
//
...
CMy2020032401Doc* CMy2020032401View::GetDocument() const // 非调试版本是内联的
{
...
// CMy2020032401View 消息处理程序


void CMy2020032401View::OnShowname()
{
	CClientDC dc(this);
	dc.TextOutW(500, 500, _T("王潇"));
	// TODO: 在此添加命令处理程序代码
}
